...
//==============================================================================
/// Overloaded operator for a correct allocation.
//==============================================================================
...
void JPtxasInfoKer::Reset(){
  Code=""; CodeMin="";
  NameSpace=""; Name=""; Args="";
  Regs_sm10=0; Regs_sm12=0; Regs_sm20=0; Regs_sm30=0;
...
//==============================================================================
/// Returns the pointer pointing at the requested kernel.
//==============================================================================
...
void JPtxasInfo::SaveCsv(const std::string &file)const{
  ...
  pf.open(file.c_str());
  if(pf){
    pf << "Sp;Kernel;TemplateVars;SM_10;SM_12;SM_20;SM_30;Args" << endl;
    for(unsigned c=0;c<Count();c++){
      ...
      pf << ker->GetRegs(10) << ";" << ker->GetRegs(12) << ";" << ker->GetRegs(20) << ";" << ker->GetRegs(30) << ";";
      pf << ker->GetArgs() << endl;
    }   
...
//==============================================================================
/// Checks information of the requested sm.
//==============================================================================
